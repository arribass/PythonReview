...
s = ''' Hi, my name is Adrian and i like to code
      in my freetime. I Like playing guitar too
...
pal3 = '012345'
print(f"the values from 1 to 4 are: {pal3[1:4]}")  # 4th value not included
...
print(x.upper())
# string, formatting, we can use fstrings in Python 3+
print("One, %d , three" % 2)
print("I have %d %s" % (4, 'dogs'))

# LISTS
# list can contain objects from different types
lista = [1, "hello", (3+2j)]
print(lista[2])
...
l1 = []  # main list for our operations , EMPTY
...
# they cannot contain mutable elements such as list or dictionaries
set1 = set()
set1 = {1, 2, 3}
print(set1)
set2 = set()
